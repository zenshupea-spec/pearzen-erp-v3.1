/**
 * Apply companies.subscription_status migration.
 * Run: npm run db:apply-companies-subscription-status
 */
...
const migrationFile = '20260621130000_companies_subscription_status.sql';
