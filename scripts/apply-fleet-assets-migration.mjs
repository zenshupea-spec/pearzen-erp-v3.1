/**
 * Applies fleet_assets tables to remote Supabase.
 * Run: npm run db:apply-fleet-assets
 */
...
const migrationPath = join(
  root,
  'packages/supabase/migrations/20260609240000_fleet_assets.sql',
);
...
async function applyViaManagementApi() {
  ...
  console.log('✅ Applied fleet_assets migration (Management API)');
  return true;
}
...
async function applyViaPostgres(dbUrl) {
  ...
  try {
    ...
    console.log('✅ Applied fleet_assets migration (Postgres)');
    return true;
  } finally {
