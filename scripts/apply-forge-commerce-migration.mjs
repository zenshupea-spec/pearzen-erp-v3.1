/**
 * Apply forge commerce migration (product catalog, purchases, invoices).
 * Run: npm run db:apply-forge-commerce
 */
...
const migrationFile = '20260621100000_forge_commerce.sql';
