/**
 * Apply forge contact thread commerce hint migration.
 * Run: npm run db:apply-forge-contact-commerce
 */
...
const migrationFile = '20260621120000_forge_contact_threads_commerce_hint.sql';
