/**
 * Apply forge_platform_health_snapshots migration.
 * Run: npm run db:apply-forge-platform-health
 */
...
const migrationFile = '20260621230000_forge_platform_health_snapshots.sql';
