/**
 * Apply forge_project_milestones migration (G1).
 * Run: npm run db:apply-forge-project-milestones
 */
...
const migrationFile = '20260621290000_forge_project_milestones.sql';
