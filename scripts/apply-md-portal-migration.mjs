/**
 * MD portal: expense_bills + shalom_properties + shalom_bookings.
 * Run: npm run db:apply-md-portal
 */
...
const sqlText = readFileSync(
  join(root, 'packages/supabase/migrations/20260615200000_md_portal_expense_bills_shalom.sql'),
  'utf8',
);
...
async function applyViaManagementApi() {
  ...
  console.log('✅ Applied MD portal migration via Management API');
  return true;
}
...
async function applyViaPg() {
  ...
  try {
    ...
    console.log('✅ Applied MD portal migration via DATABASE_URL');
    return true;
  } finally {
