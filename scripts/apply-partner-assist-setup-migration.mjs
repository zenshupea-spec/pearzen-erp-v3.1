/**
 * Apply partner assist setup migration (domains, PayHere credentials, assist grants).
 * Run: npm run db:apply-partner-assist-setup
 */
...
const migrationFile = '20260621170000_partner_assist_setup.sql';
