/**
 * Apply companies.product_bundle + md_settings.enabled_modules migration.
 * Run: npm run db:apply-product-bundle
 */
...
const migrationFile = '20260621200000_product_bundle_enabled_modules.sql';
