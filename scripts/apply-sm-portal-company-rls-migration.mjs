/**
 * Apply SM portal company-scoped RLS migration (G2).
 * Run: npm run db:apply-sm-portal-company-rls
 */
...
const migrationFile = '20260621300000_sm_portal_company_scoped_rls.sql';
