/**
 * Apply superapp_store_snapshots + superapp_export_jobs migration.
 * Run: npm run db:apply-superapp-export
 */
...
const migrationFile = '20260621240000_superapp_export.sql';
