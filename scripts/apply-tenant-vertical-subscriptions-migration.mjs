/**
 * Apply tenant_vertical_subscriptions migration.
 * Run: npm run db:apply-tenant-vertical-subscriptions
 */
...
const migrationFile = '20260621140000_tenant_vertical_subscriptions.sql';
