/**
 * Uniform suppliers, HQ stock, VO stock, and RLS.
 * Run: npm run db:apply-uniform-suppliers
 */
...
const migrationFiles = [
  'packages/supabase/migrations/20260604260000_uniform_suppliers_stock.sql',
  'packages/supabase/migrations/20260604270000_uniform_vo_stock.sql',
  'packages/supabase/migrations/20260610250000_uniform_suppliers_rls.sql',
];
...
async function applyViaManagementApi() {
  ...
  console.log('✅ Applied uniform suppliers migrations (Management API)');
  return true;
}
...
async function applyViaPostgres(dbUrl) {
  ...
  try {
    ...
    console.log('✅ Applied uniform suppliers migrations (Postgres)');
    return true;
  } finally {
